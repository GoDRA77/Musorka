...
type FriendFromApi = {
    ...
    avatar: string[];
    interest: string[];
};  // <-- Точка с запятой здесь тоже важна!
    ...
    useEffect(() => {
        const fetchFriends = async () => {
            try {
                ...
                const data: FriendFromApi[] = await res.json();
                ...
                const formatted = data.map((f) => ({
                    ...
                    lastSeen: null, // Если данных нет, лучше null
                    online: false, // По умолчанию offline, если бэк не передает статус
                }));
